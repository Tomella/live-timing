...
(function (angular) {
	...
	angular.module("LtApp", ["lt.head", "lt.table", "lt.templates"]).run(['$http', '$rootScope', '$timeout', function ($http, $rootScope, $timeout) {
		pollService();
...
(function (angular) {
   ...
   angular.module("lt.type", []).directive('ltHead', ['$rootScope', function ($rootScope) {
      return {
         restrict: 'AE',
